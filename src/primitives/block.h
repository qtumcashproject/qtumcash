...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // qtumcash
        hashUTXORoot.SetNull(); // qtumcash
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //qtumcash
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //qtumcash
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //qtumcash
    {
