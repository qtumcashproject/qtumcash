...
BOOST_AUTO_TEST_CASE(checking_btcecrecover_after_fork){
    ...
    std::vector<QtumCashTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createQtumCashTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createQtumCashTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createQtumCashTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createQtumCashTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
