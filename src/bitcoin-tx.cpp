...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " qtumcash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  qtumcash-tx [options] <hex-tx> [commands]  Update hex-encoded qtumcash transaction\n" +
            "or:     qtumcash-tx [options] -create [commands]   Create hex-encoded qtumcash transaction\n" +
            "\n";
