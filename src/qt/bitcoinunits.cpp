...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("QTH");
    case mBTC: return QString("mQTH");
    case uBTC: return QString::fromUtf8("μQTH (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("QtumCashs");
    case mBTC: return QString("Milli-QtumCashs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-QtumCashs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
