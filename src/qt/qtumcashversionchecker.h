#ifndef QTHVERSIONCHECKER_H
#define QTHVERSIONCHECKER_H

#include <QObject>

#define QTH_RELEASES "https://github.com/qtumcashproject/qtumcash/releases"
...
class QtumCashVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit QtumCashVersionChecker(QObject *parent = 0);
    ~QtumCashVersionChecker();
