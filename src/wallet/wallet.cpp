...
void CWallet::StakeQtumCashs(bool fStake, CConnman* connman)
{
    ::StakeQtumCashs(fStake, this, connman, stakeThread);
}

void CWallet::StartStake(CConnman *connman)
{
    m_enabled_staking = true;
    StakeQtumCashs(true, connman);
}
